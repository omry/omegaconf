...
class OmegaConf:
    ...
    def resolve(cfg: Container) -> None:
        ...
        results may depend on key insertion order, because custom resolvers can do
        anything — they may be stateful, have side effects, or return different values
        on each call — and this function has no way to account for that.
