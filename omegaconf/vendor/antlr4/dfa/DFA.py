...
from .vendor.antlr4.atn.ATNState import StarLoopEntryState

from .vendor.antlr4.atn.ATNConfigSet import ATNConfigSet
from .vendor.antlr4.atn.ATNState import DecisionState
from .vendor.antlr4.dfa.DFAState import DFAState
from .vendor.antlr4.error.Errors import IllegalStateException
...
class DFA(object):
    ...
    def toString(self, literalNames:list=None, symbolicNames:list=None):
        if self.s0 is None:
            return ""
        from .vendor.antlr4.dfa.DFASerializer import DFASerializer
    ...
    def toLexerString(self):
        if self.s0 is None:
            return ""
        from .vendor.antlr4.dfa.DFASerializer import LexerDFASerializer
