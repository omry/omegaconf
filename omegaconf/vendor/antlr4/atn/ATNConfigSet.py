...
from .vendor.antlr4.PredictionContext import PredictionContext, merge
...
from .vendor.antlr4.error.Errors import UnsupportedOperationException, IllegalStateException
