...
def test_re_parent() -> None:
    def validate(cfg1: DictConfig) -> None:
        ...
        assert cfg1._get_node("str")._get_parent() == cfg1
        assert cfg1._get_node("list")._get_parent() == cfg1
    ...
    cfg._get_node("str")._set_parent(None)
    cfg._get_node("list")._set_parent(None)
